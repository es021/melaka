...
try{s=o.length}catch(e){console.log(e)}s<3||(e.searchLoad=!0,u.searchLinkedUserByNameByState(o,e.userInSession.user_id).then(function(o){e.searchLinked=o.data,console.log(o),e.searchLoad=!1},function(o){l.errorCallbackFunction(o,"default"),e.searchLoad=!1}))}function d(){e.myLinkedUser={},e.myLinkedUserLoad=!0}function f(){console.log("initAgentLinked"),d(),g(e.userInSession.user_id)}function g(o){i.getLinkedUserById(o,e.pageNumber).then(function(o){console.log("Getting all getLinkedUserById"),200==o.status&&(e.myLinkedUser=o.data,e.myLinkedUserLoad=!1)},function(e){l.errorCallbackFunction(e,"Failed : getLinkedUserById")})}e.authProfile=JSON.parse(window.localStorage.getItem("AuthProfile")),e.userInSession=JSON.parse(window.localStorage.getItem("UserInSession")),e.pageNumber=t.pageNumber,console.log(e.pageNumber),e.OFFSET=s,e.search={},e.searchLinked=[],e.searchLoad=!1,e.isSubmit=!1,e.submit=function(){e.search.key&&""!=e.search.key||(e.searchLinked=[]),e.isSubmit=!0,c(e.search.key)},e.refresh=function(){f(),o.info("List is up to date",{title:"Refresh List!"})},null!=e.userInSession?f():r.go("login"),e.getMore=function(o){console.log(o)
var s=e.pageNumber
