...
getAllObjects=function(t){return e.get(n(t))},getObjectById=function(t,r){return console.log(n(t)+r),e.get(n(t)+r)},addObject=function(t,r){return e.post(n(t)+"?returnObject=true",r)},deleteObject=function(t,r){return e.delete(n(t)+r)},getAllProductByUserId=function(r,a){var n=o.THUMBNAIL*(a-1)
