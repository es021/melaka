...
myApp.config(["$stateProvider","$urlRouterProvider","authProvider",function(e,o,t){e.state("showProductList",{url:"/showProductList?user_id&refresh&pageNumber",controller:"ShowProductListController",templateUrl:"products/showProductList.html",data:{requiresLogin:!1}}),e.state("addProduct",{url:"/addProduct",controller:"AddEditProductController",templateUrl:"products/addEditProduct.html",data:{requiresLogin:!1}}),e.state("editProduct",{url:"/editProduct?id&user_id",controller:"AddEditProductController",templateUrl:"products/addEditProduct.html",data:{requiresLogin:!1}}),e.state("showProduct",{url:"/showProduct?product_id&show",controller:"ShowProductController",templateUrl:"products/showProduct.html",data:{requiresLogin:!1}})}]),myApp.controller("ShowProductController",["$scope","$ionicPopup","$location","PublicService","BackandService","NOTI_CATEGORY","$state","$stateParams","growl","TRANS_STATUS","USER_LINK_TYPE",function(e,o,t,i,n,r,s,c,u,a,d){function l(){e.userInSession.user_id==e.showObject.user_id&&(e.authenticated=!0)}function g(o,t){n.getLinkByFromIdToIdType(o,t,d.LINKED).then(function(o){console.log("getLinkByFromIdToIdType"),200==o.status&&(o.data.length>0?e.linked=!0:e.linked=!1)},function(e){i.errorCallbackFunction(e,"Opps! Something went wrong. Please Refresh Page")})}function m(o){e.loading=!0,n.getShowProductById(o).then(function(t){console.log("Data from show object"),e.showObject=t.data[0],console.log(t),console.log(e.showObject),e.loading=!1,null==e.showObject&&(e.errorMessage="There is no product with id "+o),200==t.status&&null!=e.showObject&&(e.lastUpdatedAgo=i.getAgoTime(e.showObject.updated_at),null==e.showObject.custom_pricing||""==e.showObject.custom_pricing?e.hasCustomPricing=!1:(e.hasCustomPricing=!0,e.customPricingList=JSON.parse(e.showObject.custom_pricing)),null==e.showObject.specification||""==e.showObject.specification?e.hasSpecification=!1:(e.hasSpecification=!0,e.showObject.specification=JSON.parse(e.showObject.specification)),"["==e.showObject.picture[0]?(e.imageList=JSON.parse(e.showObject.picture),console.log(e.imageList)):e.imageList.push(e.showObject.picture),null!=e.userInSession&&(l(),g(e.userInSession.user_id,e.showObject.user_id)))})}function P(){n.deleteObject("products",e.showObject.id).then(function(o){console.log("Data from delete products object"),console.log(o),200==o.status&&(u.success("Click on page title [My Product] to update list.",{title:"Successfully Delete One Product!"}),p(e.showObject.picture),s.go("showProductList",{user_id:e.userInSession.user_id,refresh:"y",pageNumber:1})),e.loading=!1},function(o){u.error("There is one or more transactions associated with this product",{title:"Failed to delete this product"}),console.log(o),e.loading=!1})}function p(e){function o(e){n.deleteFile(e).then(function(e){console.log("Result From Delete Image from Backand"),console.log(e)},function(e){console.log(e)})}if("["==e[0])for(var t=JSON.parse(e),i=0;i<t.length;i++)o(t[i])
else o(e)}e.showObject=null,e.lastUpdated=null,e.hasCustomPricing=null,e.customPricingList=[],e.imageList=[],e.productId=c.product_id,e.show=c.show,null==e.show&&(e.show="info"),e.loading=!1,e.userInSession=JSON.parse(window.localStorage.getItem("UserInSession")),e.authProfile=JSON.parse(window.localStorage.getItem("AuthProfile")),m(e.productId),e.newRequest={},e.delivery_address={},e.newRequest.total_price=0,e.loadingRequest=!1,e.refresh=function(o){console.log("Refresh"),m(e.productId),u.info(o+" is up to date",{title:"Refresh List!"})},e.updateTotalPrice=function(){if(e.hasCustomPricing){for(var o=0,t=0;t<e.customPricingList.length;t++)if(e.newRequest.quantity<=e.customPricingList[t].to){o=e.customPricingList[t].price
...
e.newRequest.total_price=e.newRequest.total_price.toFixed(2),isNaN(e.newRequest.total_price)&&(e.newRequest.total_price=0)},e.editProduct=function(e,o){console.log("Edit Product Page"),s.go("editProduct",{id:e,user_id:o})},e.requestProduct=function(){return e.loadingRequest=!0,null==e.showObject?(i.errorCallbackFunction(null,"Failed to Send Request"),void(e.loadingRequest=!1)):(e.newRequest.from_user_id=e.userInSession.user_id,e.newRequest.to_user_id=e.showObject.user_id,e.newRequest.product_id=e.productId,e.newRequest.status=a.REQUESTED,e.newRequest.payment_status=a.NOT_PAID,e.newRequest.created_at=n.getTimestampinMysql(),e.newRequest.updated_at=n.getTimestampinMysql(),"Pick Up"!=e.newRequest.type&&(console.log(e.delivery_address),e.newRequest.delivery_address=JSON.stringify(e.delivery_address),console.log(e.newRequest.delivery_address)),void n.addObject("transactions",e.newRequest).then(function(o){console.log("Result From Creating new Request"),console.log(o),200==o.status&&(u.success("Click on page title [My Active Listing] to update list.",{title:"Successfully Added New Request!"}),s.go("myActiveListing",{pageNumber:1,refresh:"y"}),n.createNotification(o.data.to_user_id,"New product request from "+e.userInSession.first_name,"/showTransaction?id="+o.data.id+"&other_user_id="+e.userInSession.user_id,r.PRODUCT)),e.loadingRequest=!1},function(o){i.errorCallbackFunction(o,"Failed to Send Request"),e.loadingRequest=!1}))},e.authenticated=!1,e.linked=!1,e.showFunction=function(o){e.show=o},e.comfirmDeleteProduct=function(){e.loading=!1
